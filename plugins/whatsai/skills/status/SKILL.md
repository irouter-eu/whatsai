---
name: status
description: Read or publish explicit working, blocked, or ready task status with a description.
---

Read or publish explicit working, blocked, or ready task status with a description.
