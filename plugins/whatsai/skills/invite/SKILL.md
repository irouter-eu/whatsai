---
name: invite
description: Display the current team join descriptor. It is a convenience link; admins still approve each new member.
---

Display the current team join descriptor. It is a convenience link; admins still approve each new member.
