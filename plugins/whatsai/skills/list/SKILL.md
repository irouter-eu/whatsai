...
Each member's `agents` entry lists labels like `claude@repo` with harness, workspace name, repository, online flag and last-seen time. Those labels are what `to_agent` accepts when sending.
